...
role5 "\"啊！ \""
narrator_nvl "\"正在我不断地想要用一些较为轻松的想法，在一众消极因素里解救出自己的积极心态时，春日突然发出的叫声，把我的思维拉回了阴暗空旷的隧道里。\""
narrator_nvl "\"她的身子迅速地向前扑去，左手也离开了岩壁，挥舞到了半空中——很明显是失去了平衡的缘故，并且由于和我紧握双手的关系，几乎把我也拉到了摔倒的境地。 \""
narrator_nvl "\"我急忙把身体往后倾斜，并借助着右手触碰到的一块突起的岩石，在体重、地心引力和惯性的共同作用下，才勉强把她拉了起来，避免了她磕在隧道的某个地方。\""
nvl clear
role3 "\"你没事吧？！春日。 \""
nvl clear
narrator_nvl "\"借着手机屏幕的亮光，我勉强看清了她的表情——涨红了脸，流露出一股由惊慌、不满和似乎是害羞的情绪所组成的复杂表情。看样子她也快到极限了。 \""
role4 "\"没，没事。\""
